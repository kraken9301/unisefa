...
$queryUsuario = "SELECT u.id AS id_usuario, e.id AS id_estudiante, e.id_curso FROM usuarios u 
                 JOIN estudiantes e ON u.id = e.id_usuario WHERE u.usuario = ?";
...
$queryPedido = "SELECT * FROM pedidos WHERE id_estudiante = ?";
$stmtPedido = $conn->prepare($queryPedido);
$stmtPedido->bind_param("i", $idEstudiante);
$stmtPedido->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Pedidos Estudiante</title>
...
<div class="container mt-4">
    ...
    <h2>Hola Estudiante, <?php echo htmlspecialchars($usuario); ?></h2>
    <div>
        ...
        <div class="col-md-3 mb-4">
            <div class="card card-producto">
                ...
                <div class="card-body card-body-producto">
                    ...
                    <form method="post" action="agregar_al_pedido.php">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <?php if ($detallePedido): ?>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="eliminar_detalle.php?id=<?php echo $item['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Eliminar este producto del pedido?')">Eliminar</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <a href="imprimir_pedido.php?id=<?php echo $idPedido; ?>" target="_blank" class="btn btn-info">Imprimir PDF</a>
            <?php else: ?>
